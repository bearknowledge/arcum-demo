    ...
    const filterRows = useCallback(() => {
        ...
        if (riskFilter !== "") {
            filteredCustomers = filteredCustomers.filter((rowValue) => {
                return rowValue.risk === riskFilter;
            });
        }
                                        ...
                                        {rows
                                            ...
                                            .map((singleCustomer) => (
                                                ...
                                                >
                                                    ...
                                                    <TableCell>
                                                        {
                                                            singleCustomer.tenure_years
                                                        }
                                                    </TableCell>
                                                    <TableCell>
                                                        {numFormatter.format(
                                                            singleCustomer.volume
                                                        )}
                                                    </TableCell>
                                                    <TableCell>
                                                        {numFormatter.format(
                                                            singleCustomer.revenue
                                                        )}
                                                    </TableCell>
                                                    <TableCell>
                                                        <SeverityPill
